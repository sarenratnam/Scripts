...
public class CraftingBench : Inventory
{
    ...
    public void CreateBlueprints()
    {
		...
		craftingItems.Add("EMPTY-Electron-EMPTY-EMPTY-Neutron-EMPTY-EMPTY-Proton-EMPTY-", InventoryManager.Instance.ItemContainer.Weapons.Find(x => x.ItemName == "Carbon"));
